...
from aux_models import vgg19_model, copycat_model
...
detector_path = 'models/weights_best_unknown_sigma0.050.h5'
# Boxes
...
detector = copycat_model(img_rows=img_rows, img_cols=img_cols,
                          channels=nchannels,
                          nb_classes=2)
...
det_logits_mod = detector_wrap.get_logits(new_image)
det_probs_mod  = detector_wrap.get_probs(new_image)
...
for patch_idx in range(num_patches):
    ...
    for step_idx in range(lambda_steps):
        ...
        # Create a filename
        filename = 'results/cifarVgg19_CWgraybox_%s_patch%d_iterations%d_confidence%.1f_step%d.mat' % (
        ...
        for i in range(num_iterations):                    
            ...
            feed_dict_mod = {x: x_clean_tanh, # We always feed the clean image in this, since modifier is separate
            ...
            np_loss_joint, np_max_loss_joint, np_joint_logits, np_newimg = sess.run([trainer, grad_joint, modifier_loss,
